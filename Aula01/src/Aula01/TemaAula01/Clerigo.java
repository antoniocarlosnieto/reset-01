...
public class Clerigo extends Sacerdote {
    ...
    Clerigo(final String nome, final double vida, final double ataque, final double defesa, final int fe) {
...
class Clerigo {
    ...
    Clerigo(String nome, int vida, int ataque, int defesa, int fe) {
        this.nome = nome;
        this.vida = vida;
        this.ataque = ataque;
        this.defesa = defesa;
